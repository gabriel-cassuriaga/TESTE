...
const faturamentoTotal = diasComFaturamento.reduce((acumulado, dia) => acumulado + dia.valor, 0);
...
console.log('Dias com faturamento: ');
...
console.log('Quantidade de dias acima da media: ' + diasAcimaDaMedia);
